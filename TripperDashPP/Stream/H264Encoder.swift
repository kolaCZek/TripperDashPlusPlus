...
//
//  Configuration: baseline profile, 30 fps, ~600 kbps, keyframe every
//  60 frames (2 s). These match what the Tripper dash tolerates per
//  better-dash captures — high profile + B-frames break the firmware
//  decoder.
//
