...
- **Keyless ride-data services (cellular, no account)**: Open-Meteo (weather pill) and OpenStreetMap Overpass (speed-camera overlay) — both keyless, consistent with the free-account stance.
